################################################################################
#
# Created by icc2 split_constraints on Sun Mar 12 00:20:31 2023
#
################################################################################
...
#   virtual_:  Instance 'I_PCI_TOP' (top mode 'func')
...
#
# Boundary constraints for instance 'I_PCI_TOP' (top mode 'func')
#
...
# Virtual clock virtual_PCI_CLK.8_r based on original clock PCI_CLK 
create_clock -name {virtual_PCI_CLK.8_r} -period 7.50000  \
