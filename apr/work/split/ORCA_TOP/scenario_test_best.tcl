...
set_driving_cell -lib_cell INVX2_HVT -library saed32hvt_ff0p95vn40c [get_ports \
    {sd_DQ_in[0]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 5 [get_ports {shutdown}]
set_input_delay -clock [get_clocks {ate_clk}] -max 5 [get_ports {test_mode}]
set_input_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_si[5]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_si[4]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_si[3]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_si[2]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_si[1]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_si[0]}]
set_output_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_so[5]}]
set_output_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_so[4]}]
set_output_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_so[3]}]
set_output_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_so[2]}]
set_output_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_so[1]}]
set_output_delay -clock [get_clocks {ate_clk}] -max 3 [get_ports {test_so[0]}]
set_input_delay -clock [get_clocks {ate_clk}] -max 5 [get_ports {scan_enable}]
set_input_delay -clock [get_clocks {ate_clk}] -max 5 [get_ports {occ_bypass}]
set_input_delay -clock [get_clocks {ate_clk}] -max 5 [get_ports {occ_reset}]
set_input_delay -clock [get_clocks {ate_clk}] -max 5 [get_ports {prst_n}]
...
# MD5_SIGNATURE: F29BA53F1EDEB176A743DEA111A5F270 
