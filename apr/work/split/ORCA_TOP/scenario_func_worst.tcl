...
set_input_delay -clock [get_clocks {v_PCI_CLK}] -min 2 [get_ports \
    {pdevsel_n_in}]
set_input_delay -clock [get_clocks {v_PCI_CLK}] -max 4 [get_ports \
    {pdevsel_n_in}]
set_output_delay -clock [get_clocks {v_PCI_CLK}] -min -1 [get_ports \
    {pdevsel_n_out}]
set_output_delay -clock [get_clocks {v_PCI_CLK}] -max 3 [get_ports \
...
# MD5_SIGNATURE: 2107323EBDA59C8B45413954A6DE1BA0 
