################################################################################
#
# Created by icc2 split_constraints on Sun Mar 12 00:20:15 2023
#
################################################################################
...
#   virtual_:  Instance 'I_SDRAM_TOP' (top mode 'func')
...
#
# Boundary constraints for instance 'I_SDRAM_TOP' (top mode 'func')
#
...
# Virtual clock virtual_SDRAM_CLK.8_r based on original clock SDRAM_CLK 
create_clock -name {virtual_SDRAM_CLK.8_r} -period 4.10000  \
	-waveform {0.00000 2.05000} 
group_path -priority -1 -name {SDRAM_CLK} -to [get_clock  \
	{virtual_SDRAM_CLK.8_r}]
...
# /home/ramadugu/common/Documents/final_prj-team_5_master/constraints/ORCA_TOP.sdc, line 108
...
set_false_path -from [get_clocks {virtual_SDRAM_CLK.top_r  \
	virtual_SDRAM_CLK.top_f virtual_SDRAM_CLK.8_r}] -to [get_clocks { \
	virtual_SD_DDR_CLK_r virtual_SD_DDR_CLK_f}]
...
# Other constraints
# /home/ramadugu/common/Documents/final_prj-team_5_master/constraints/ORCA_TOP_func_worst.sdc, \
#   line 795
...
# MD5_SIGNATURE: A0442C449C5CDA8A2724FD2F08CCDA01 
