...
set_clock_transition 0.2 [get_clocks {SYS_CLK/sys_clk SYS_CLK/sys_clk_cts_4 \
...
set_max_transition 0.15 [get_clocks {SYS_CLK/sys_clk SYS_CLK/sys_clk_cts_4 \
    SYS_CLK/sys_clk_cts_6_BAR}] -clock_path
set_max_transition 0.15 [get_clocks {SDRAM_CLK}] -clock_path

# MD5_SIGNATURE: AAEEFD6E44A2533989958F2C7B4537B1 
