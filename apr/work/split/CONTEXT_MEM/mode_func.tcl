################################################################################
#
# Created by icc2 split_constraints on Sun Mar 12 00:20:28 2023
#
################################################################################
...
#   virtual_:  Instance 'I_CONTEXT_MEM' (top mode 'func')
...
#
# Boundary constraints for instance 'I_CONTEXT_MEM' (top mode 'func')
#
...
set_clock_groups -name func_async -asynchronous -group [get_clocks {SYS_2x_CLK \
    ...
    SD_DDR_CLKn}]
# MD5_SIGNATURE: A857C667906F0EF4FB9B43081A7BF5B9 
