################################################################################
#
# Created by icc2 split_constraints on Sun Mar 12 00:20:25 2023
#
################################################################################
...
#   virtual_:  Instance 'I_RISC_CORE' (top mode 'func')
...
#
# Boundary constraints for instance 'I_RISC_CORE' (top mode 'func')
#
...
# Virtual clock virtual_SYS_2x_CLK.8_r based on original clock SYS_2x_CLK 
create_clock -name {virtual_SYS_2x_CLK.8_r} -period 2.40000  \
	-waveform {0.00000 1.20000} 
group_path -priority -1 -name {SYS_2x_CLK} -to [get_clock  \
	{virtual_SYS_2x_CLK.8_r}]
